...
def sort_page_blocks(blocks, page_width):
    ...
    for b in blocks:
        ...
        if x0 < page_width * 0.38 and x1 > page_width * 0.62 and width > page_width * 0.4:
...
def merge_blocks(sorted_blocks):
    ...
    for b in sorted_blocks:
        ...
        if current_block is None:
            ...
            should_merge = same_column and y_dist < 40 and is_continuation and not starts_with_bullet
